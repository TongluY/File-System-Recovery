...
int main(int argc, char **argv)
{
    ...
    for (unsigned int j = 0; j < num_groups; j++)
    {
        for (unsigned int i = 0; i < super.s_inodes_per_group; i++)
        {
            ...
            read_inode(fd, start_inode_table, i, inode, 2 * sizeof(inode));
            ...
            if (S_ISREG(inode->i_mode))
            {
                ...
                for (unsigned int i = 0; i < EXT2_N_BLOCKS; i++)
                {
                    ...
                    { /* single indirect block */
                        ...
                        for (unsigned int j = 0; j < 1024 / 4; j++)
                        {
                    ...
                    { /* double indirect block */
                        ...
                        for (unsigned int j = 0; j < 1024 / 4; j++)
                        {
                            ...
                            if (j <= i_blocks)
                            {
                                ...
                                for (unsigned int k = 0; k < 1024 / 4; k++)
                                {
    ...
    for (unsigned int j = 0; j < num_groups; j++)
    {
        for (unsigned int i = 0; i < super.s_inodes_per_group; i++)
        {
			...
			read_inode(fd, start_inode_table, i+1, inode, 2 * sizeof(inode));
